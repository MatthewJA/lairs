    ...
    \label{sec:missing-emission}
        ...
        \begin{figure}
            ...
            \begin{subfigure}{0.45\textwidth}
                ...
                \caption{Murriyang at Parkes Observatory}
                \label{fig:murriyang}
            \end{subfigure}
            \begin{subfigure}{0.45\textwidth}
        ...
        Radio observations may be made either with \defn{single-dish telescopes}, like Murriyang, or \defn{radio arrays}, like the Australia Telescope Compact Array (ATCA), both shown in \autoref{fig:telescopes}.
