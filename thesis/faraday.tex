...
\label{sec:faraday-real-data-fig}
  ...
  This section contains \autoref{fig:faraday-all-observed-fdfs-lr} and \autoref{fig:faraday-all-observed-fdfs-xgb}, which shows the predicted probability of being Faraday complex for all real data used in this paper, drawn from \citet{livingston21faraday} and \citet{osullivan_broad-band_2017}.
