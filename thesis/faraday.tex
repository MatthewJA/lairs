...
\label{sec:faraday-hyperparameters}
  ...
  This section contains tables of the hyperparameters that we used for our classifiers. \autoref{tab:faraday-hyperparameters-xgb} and \autoref{tab:faraday-hyperparameters-lr} tabulate the hyperparameters for XGB and LR respectively for the `ATCA' dataset. \autoref{tab:faraday-hyperparameters-xgb-askap12} and \autoref{tab:faraday-hyperparameters-lr-askap12} tabulate the hyperparameters for XGB and LR respectively for the `ASKAP' dataset.
...
\label{sec:faraday-cms}
  ...
  This section contains confusion matrices for our classifiers evaluated on simulated ATCA and ASKAP data, as well as a confusion matrix from the state-of-the-art CNN classifier on simulated ASKAP data. \autoref{tab:faraday-cm-lr-askap12}, \autoref{tab:faraday-cm-lr-askap12}, and \autoref{tab:faraday-cm-brown} are confusion matrices on the `ASKAP' dataset for LR, XGB, and CNN respectively. \autoref{tab:faraday-cm-lr} and \autoref{tab:faraday-cm-xgb} are confusion matrices on the `ATCA' dataset for LR and XGB respectively.

    \begin{table}[htbp]
      \caption{\label{tab:faraday-cm-lr-askap12} Logistic regression confusion matrix for the `ASKAP' dataset.}
      \begin{tabular}{r|cc}
        \hline\hline
      ...
      \end{tabular}\\
      \\
      \caption{\label{tab:faraday-cm-xgb-askap12} XGB confusion matrix for the `ASKAP' dataset.}
      \begin{tabular}{r|cc}
        \hline\hline
        & Pred. simple & Pred. complex \\\hline
        True simple & 0.99 & 0.01 \\
      ...
      \end{tabular}\\
      \\
      \caption{\label{tab:faraday-cm-brown} CNN confusion matrix for the `ASKAP', adapted from \citet{brown_classifying_2018}.}
      \begin{tabular}{r|cc}
        \hline\hline
        & Pred. simple & Pred. complex \\\hline
    ...
    \begin{table}[htbp]
      \caption{\label{tab:faraday-cm-lr} Logistic regression confusion matrix for the `ATCA' dataset.}
      \begin{tabular}{r|cc}
        \hline\hline
        & Pred. simple & Pred. complex \\\hline
      ...
      \end{tabular}\\
      \\
      \caption{\label{tab:faraday-cm-xgb} XGB confusion matrix for the `ATCA' dataset.}
      \begin{tabular}{r|cc}
        \hline\hline
        & Pred. simple & Pred. complex \\\hline
...
\label{sec:faraday-real-data-fig}
  ...
  This section contains \autoref{fig:faraday-all-observed-fdfs-lr} and \autoref{fig:faraday-all-observed-fdfs-xgb}, which shows the predicted probability of being Faraday complex for all real data used in this chapter, drawn from Livingston et al. (2020, submitted) and \citet{osullivan_broad-band_2017}.
...
\unappendix
  ...
  % If we were to run our classifiers at scale on the upcoming POSSUM survey, how would the limitations presented in \autoref{sec:faraday-faraday-results-simulated} affect derived statistics of Faraday complexity? 
