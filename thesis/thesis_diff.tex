...
%DIF DEL /Users/alger/repos/lairs-2/thesis/thesis.tex   Mon Sep  6 22:42:09 2021
...
\label{sec:radio-astronomy}
    ...
    \label{sec:polarisation}
        ...
        Of course, no physical source has a precise Faraday depth, as there is always intrinsic scatter. Along the line of sight, if we assume \DIFdelbegin \DIFdel{Gaussian noise in an otherwise-constant }\DIFdelend \DIFaddbegin \DIFadd{that }\DIFaddend $n_e$ \DIFaddbegin \DIFadd{is observed with random Gaussian noise }\DIFaddend i.e. $n_e(z) \sim \mathcal N(\overline n_e, \sigma_{n_e}^2)$, and \DIFdelbegin \DIFdel{a constant }\DIFdelend \DIFaddbegin \DIFadd{that }\DIFaddend $B$ \DIFaddbegin \DIFadd{is constant }\DIFaddend for simplicity, then we find
        \begin{equation}
