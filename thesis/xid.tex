...
\section{Data}\label{sec:atlas-xid-data}
  ...
  \subsection{Binary Classifiers}\label{sec:atlas-xid-classifiers}
    ...
    \subsection{Classification models}\label{sec:atlas-xid-models}
      ...
      \label{sec:atlas-xid-logistic-regression}
      ...
      \label{sec:atlas-xid-convolutional-neural-networks}
...
\section{Results}\label{sec:atlas-xid-results}
  ...
  \label{sec:atlas-xid-cdfs-results}
    ...
    cross-identification for each ATLAS object in \aref{sec:atlas-xids}.
...
\section{Cross-identification figures}\label{sec:atlas-xid-examples}
    ...
    \begin{figure*}
      ...
      % \subfloat[]{\includegraphics{atlas-images/examples_all/example_sorted_1_425.pdf}}
