...
\section{Data}\label{sec:atlas-data}
  ...
  \subsection{ATLAS}\label{sec:atlas-atlas}
    \begin{table}
  ...
  \subsection{SWIRE}\label{sec:atlas-swire}
  ...
  \subsection{Radio Galaxy Zoo}\label{sec:atlas-rgz}
  ...
  \section{Method}\label{sec:atlas-method}
    \begin{figure}
      \centering
  ...
  {The aim of this paper is to express cross-identification in a form that
  ...
  \subsection{Cross-identification as binary classification}\label{sec:atlas-xid-as-binary-classification}
    ...
    \autoref{sec:atlas-limitations}.}. Radio cross-identification can then
    ...
    highest-scored location coincides with the desired object (\eref{eq:atlas-score}). Square image
    ...
    \begin{algorithm}
        ...
        \For{$g \in \mathcal G$}{
          ...
          $score \leftarrow f(x) \times \frac{1}{\sqrt{2\pi\sigma^2}} \exp\left(-\frac{d^2}{2\sigma^2}\right);\quad \stepcounter{equation}\hfill(\theequation)\label{eq:atlas-score}$
          \BlankLine
          \If{$score > max$}{
            $max \leftarrow score$\;
            $host \leftarrow g$\;
  ...
  \subsection{Limitations of our approach}
    ...
    \begin{figure}
      \centering
      \includegraphics[width=\linewidth]{atlas-images/FIRSTJ151227_fig.pdf}
  ...
  \subsection{Binary Classifiers}\label{sec:atlas-classifiers}
  ...
  \subsection{Labels}\label{sec:atlas-labels}
  ...
  \label{sec:atlas-experimental-setup}
...
\section{Results}\label{sec:atlas-results}
  ...
  \label{sec:atlas-cdfs-results}
    ...
    \begin{figure}
      ...
      \caption[Predicted host galaxies in the candidate classification task for ATLAS3~J032929.61-281938.9]{Predicted host galaxies in the candidate classification task for ATLAS3~J032929.61-281938.9. {The background image is an ATLAS radio image.} Radio Galaxy Zoo host galaxies
    ...
    We noted in \autoref{sec:atlas-labels} that the test set of expert labels,
...
\section{Discussion}
  ...
  these assumptions in \autoref{sec:atlas-limitations}, and we will discuss here how
  ...
  {\aref{app:examples} (see \autoref{fig:examples}) shows examples of incorrectly cross-identified
