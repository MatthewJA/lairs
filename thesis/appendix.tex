...
\todo{Fix these to be their own chapter.}
...
\label{sec:rlfs-verification-appendix}
  ...
  \begin{table}
    \caption[Validation objects.]{\label{tab:verification-set} Validation objects. `Agree' is whether or not the authors agreed with BXID associating the given FIRST object with the given All\emph{WISE} object.}
      \begin{tabular}{ccc}
