...
\label{sec:models}
    ...
    \label{sec:logistic-regression}
        ...
        We apply logistic regression to binary classification problems in \autoref{cha:cross-id} and \autoref{cha:faraday}. \todo{reflect on scores/class probabilities/predicted classes}
